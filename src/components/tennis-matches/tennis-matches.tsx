...
export class TennisMatches implements ComponentInterface {
  ...
  matchesRoundB: TennisMatchI[] = [
    ...
    },
    {
      ...
      matchData: {
        ...
        roundLabel: "Second Round",
        courtName: "Court Philippe-Chatrier",
        durationInMinutes: 247,
        endTimestamp: 1578396511000,
        status: "FINISHED",
        statusLabel: "Completed"
      },
      teamA: {
    ...
    },
    {
      ...
      matchData: {
        ...
        roundLabel: "Second Round",
        courtName: "Court Simonne-Mathieu",
        durationInMinutes: 263,
        endTimestamp: 1578338189000,
        status: "FINISHED",
        statusLabel: "Completed"
      },
      teamA: {
    ...
    },
    {
      ...
      matchData: {
        ...
        roundLabel: "Second Round",
        courtName: "Court Suzanne-Lenglen",
        durationInMinutes: 273,
        endTimestamp: 1578338318000,
        status: "FINISHED",
        statusLabel: "Completed"
      },
      teamA: {
  ...
  matchesRoundC: TennisMatchI[] = [
    {
      id: "SM016",
      url: "/en-us/matches/SM016",
      matchData: {
        type: "SM",
        typeLabel: "Men’s Singles",
        round: 3,
        roundLabel: "Third Round",
        courtName: "Court Philippe-Chatrier",
        durationInMinutes: 124,
        endTimestamp: 1578414477000,
        status: "FINISHED",
        statusLabel: "Completed"
      },
      teamA: {
    ...
    },
    {
      ...
      matchData: {
        ...
        roundLabel: "Third Round",
        courtName: "Court 14",
        durationInMinutes: 262,
        endTimestamp: 1578414774000,
        status: "FINISHED",
        statusLabel: "Completed"
      },
      teamA: {
    ...
    },
    {
      ...
      matchData: {
        ...
        roundLabel: "Third Round",
        courtName: "Court 1",
        durationInMinutes: 196,
        endTimestamp: 1578407554000,
        status: "FINISHED",
        statusLabel: "Completed"
      },
      teamA: {
    ...
    },
    {
      ...
      matchData: {
        ...
        roundLabel: "Third Round",
        courtName: "Court Simonne-Mathieu",
        durationInMinutes: 207,
        endTimestamp: 1578397600000,
        status: "FINISHED",
        statusLabel: "Completed"
      },
      teamA: {
    ...
    },
    {
      ...
      matchData: {
        ...
        roundLabel: "Third Round",
        courtName: "Court 1",
        durationInMinutes: 266,
        endTimestamp: 1578397170000,
        status: "FINISHED",
        statusLabel: "Completed"
      },
      teamA: {
  ...
  setOpponents(matches: TennisMatchI[]): OpponentsI[] {
    ...
    for (let index = 0; index < matches.length / 2; index++) {
      const matchA = matches[index * 2];
      const matchB = matches[index * 2 + 1];
  ...
  componentWillLoad() {
    this.matchesRoundAOpponents = this.setOpponents(this.matchesRoundA);
    this.matchesRoundBOpponents = this.setOpponents(this.matchesRoundB);
    this.matchesRoundCOpponents = this.setOpponents(this.matchesRoundC);
  }
      ...
      <Host>
        <div class="matches-container">
          <section class="matches show-only-on-small-size">
            <h3 class="like-h3">
              {this.matchesRoundA[0].matchData.roundLabel}
            </h3>
            {this.matchesRoundAOpponents.map((opponents) => {
              return (
                <ul class="opponents">
                  <li class="match-team">
                    <tennis-match
                      key="a"
                      match={opponents.matchA}
                    ></tennis-match>
                  </li>
                  <li class="match-team">
                    <tennis-match
                      key="b"
                      match={opponents.matchB}
                    ></tennis-match>
                  </li>
                </ul>
              );
          ...
          <section class="matches show-only-on-medium-size m-left">
            <h3 class="like-h3">
              {this.matchesRoundA[0].matchData.roundLabel}
            </h3>
            {this.matchesRoundAOpponents.map((opponents) => {
          ...
          <section class="matches show-only-on-medium-size m-center">
            <h3 class="like-h3">
              {this.matchesRoundB[0].matchData.roundLabel}
            </h3>
            {this.matchesRoundBOpponents.map((opponents) => {
              return (
                <ul class="opponents">
                  <li class="match-team">
                    <tennis-match
          ...
          <section class="matches show-only-on-large-size m-left">
            <h3 class="like-h3">
              {this.matchesRoundA[0].matchData.roundLabel}
            </h3>
            {this.matchesRoundAOpponents.map((opponents) => {
          ...
          <section class="matches show-only-on-large-size m-center">
            <h3 class="like-h3">
              {this.matchesRoundB[0].matchData.roundLabel}
            </h3>
            {this.matchesRoundBOpponents.map((opponents) => {
          ...
          <section class="matches show-only-on-large-size m-right">
            <h3 class="like-h3">
              {this.matchesRoundC[0].matchData.roundLabel}
            </h3>
            {this.matchesRoundCOpponents.map((opponents) => {
              return (
                <ul class="opponents">
                  <li class="match-team">
                    <tennis-match
